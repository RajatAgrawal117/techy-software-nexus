...
import { FaPhone, FaEnvelope, FaMapPin } from 'react-icons/fa'; // Import the icons
  ...
  return (
    <section id="contact" className="container py-12 md:py-24 lg:py-32">
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-12">
        <Feature icon={<FaPhone />} title="Phone" description="+1 (555) 123-4567" />
        <Feature icon={<FaEnvelope />} title="Email" description="info@nexussoftware.com" />
        <Feature icon={<FaMapPin />} title="Address" description="123 Main Street, Anytown, USA" />
      </div>
    </section>
  );
}
